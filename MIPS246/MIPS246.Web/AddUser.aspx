          ...
          <div>
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td class="userinfoRight">
                        <p><asp:RadioButton ID="MaleRadioButton" runat="server" GroupName="Sex" Text="男" Checked="true" />
                        <asp:RadioButton ID="FemaleRadioButton" runat="server" GroupName="Sex" Text="女" /></p>
