...
public partial class TestCodeGeneatorRequest : System.Web.UI.Page
{
    ...
    public static string GeneatorCode(string num)
    {
        ...
        {
            if (mnemonic == Mnemonic.MTC0 || mnemonic == Mnemonic.MFC0 || mnemonic == Mnemonic.MTLO || mnemonic == Mnemonic.MTHI || mnemonic == Mnemonic.MFLO || mnemonic == Mnemonic.MFHI || mnemonic == Mnemonic.ERET || mnemonic == Mnemonic.SYSCALL || mnemonic == Mnemonic.BREAK || mnemonic == Mnemonic.MULTU || mnemonic == Mnemonic.MULT || mnemonic == Mnemonic.DIVU || mnemonic == Mnemonic.DIV || mnemonic == Mnemonic.DIV || mnemonic == Mnemonic.ADD || mnemonic == Mnemonic.ADDU || mnemonic == Mnemonic.SUB || mnemonic == Mnemonic.SUBU || mnemonic == Mnemonic.AND || mnemonic == Mnemonic.OR || mnemonic == Mnemonic.XOR || mnemonic == Mnemonic.NOR || mnemonic == Mnemonic.SLT || mnemonic == Mnemonic.SLTU || mnemonic == Mnemonic.SLL || mnemonic == Mnemonic.SRL || mnemonic == Mnemonic.SRA || mnemonic == Mnemonic.SLLV || mnemonic == Mnemonic.SRLV || mnemonic == Mnemonic.SRAV || mnemonic == Mnemonic.ADDI || mnemonic == Mnemonic.ADDIU || mnemonic == Mnemonic.ANDI || mnemonic == Mnemonic.ORI || mnemonic == Mnemonic.XORI || mnemonic == Mnemonic.LUI || mnemonic == Mnemonic.SLTI || mnemonic == Mnemonic.SLTIU)
            {
